...
public class ViajeDTO {
    ...
    PasajerosDTO pasajeroViaje;

    ConductoresDTO conductoresViaje;
    ...
    public PasajerosDTO getPasajeroViaje() {
        return pasajeroViaje;
    }

    public void setPasajeroViaje(PasajerosDTO pasajeroViaje) {
        this.pasajeroViaje = pasajeroViaje;
    }

    public ConductoresDTO getConductoresViaje() {
        return conductoresViaje;
    }

    public void setConductoresViaje(ConductoresDTO conductoresViaje) {
